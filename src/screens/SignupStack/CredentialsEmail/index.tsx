  ...
  return (
    <Container>
      ...
      <FooterArea>
        <ButtonBox
          title="계속"
          disabled={emailAuth.length === 0 ? true : false}
          color={
            emailAuth.length === 0 ? theme.COLORS.BG_GRAY2 : theme.COLORS.BLUE1
          }
          fontColor={
            emailAuth.length === 0 ? theme.COLORS.GRAY1 : theme.COLORS.WHITE
          }
